...
<div id="Container1" style="background-color: red">
    <div id="Hhh" style="background-color: #5e5e5e;border-bottom: solid #ee2033 10px" >
        ...
        <div id="form_password_rex" style="margin-top: 15%">
            ...
            <form role="form" method="POST" action="{{ url('/password/email') }}" id="form2" style="display: block; padding-bottom: 20px; padding-top: 10px;margin-left: 37%; margin-top: 3%;position: absolute">
