                    ...
                    <course >
                        ...
                        <div id="course_info" >
                            ...
                            {!! Html::image('img/edit.png',null) !!}<div>EDIT</div></a>
                                    ...
                                    <span><tag id="zinziling{{ $course->id }}"><svg  version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50px" viewBox="0 0 1024 1024" enable-background="new 0 0 1024 1024" xml:space="preserve" >
...
</svg> <likez >{{ \App\Like::where('course','=',$course->id)->count() }}</likez> </tag></span>
