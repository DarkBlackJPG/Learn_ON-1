...
<div id="poljeF"  style="font-family: Exo">
    @if($user->level==0)
        ...
        {!! Form::submit('Make Admin',['class'=>'btn1','id'=>'make_admin','style'=>'width:80px; left:50%;top:187px; position:absolute']) !!}
        {!! Form::close() !!}
    @else
        {!! Form::open(['url'=>'user_admin', 'method'=>'POST']) !!}
        {!! Form::hidden('id', $user->id) !!}
        {!! Form::submit('Make User',['class'=>'btn1','id'=>'make_user','style'=>'width:80px; left:50%;top:187px; position:absolute']) !!}
        {!! Form::close() !!}
    @endif
    ...
    <div id="text4" style="padding-left: 25px; left:20%;top:3%; position:absolute">E-mail:{{$user->email}}<a href="#" id="p_link1" style="font-size:15px" class="link"> [edit]</a>
    ...
    <div id="text4" style="padding-left: 25px; left:20%;top:35%; position:absolute">Username:{{$user->username}} <a href="#" id="p_link2" style="font-size:15px" class="link"> [edit]</a>
